-- wantsome call-related tables
-- Run this after 002_point_charges.sql in the Supabase SQL editor.
...
CREATE TABLE IF NOT EXISTS creators (
  ...
  settlement_rate NUMERIC DEFAULT 0.5,        -- 기본 정산율 50%
  is_online       BOOLEAN DEFAULT FALSE,
  mode_blue       BOOLEAN DEFAULT TRUE,
  mode_red        BOOLEAN DEFAULT FALSE,
  monthly_minutes INTEGER DEFAULT 0,          -- monthly accumulated call minutes
