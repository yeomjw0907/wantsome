...
원썸 컴퍼니(이하 "회사")와 크리에이터(이하 "크리에이터")는 아래와 같이 용역계약을 체결합니다.

제1조 (목적)
본 계약은 회사가 운영하는 wantsome 플랫폼을 통해 크리에이터가 영상통화 서비스를 제공함에 있어 필요한 권리와 의무를 정함을 목적으로 합니다.
...
제3조 (수수료 및 정산)
1. 크리에이터의 기본 정산율은 통화 포인트의 75%입니다.
2. 활동 등급에 따라 정산율이 달라질 수 있습니다 (신규 55% ~ 탑 70%).
